...
if(0)  % dobor wartosci wspolczynnikow wielomianow zmiennej 's' transmitancji
   ...
   wzm = 0.001;
   z = j*2*pi*[ 600,800 ];         z = [z conj(z)];  % zera na czestotliwosciach 600 i 800 Hz
   p = [-1,-1] + j*2*pi*[100,200]; p = [p conj(p)];  % bieguny z tłumieniem na czestotliwosciach 100 i 200 Hz
